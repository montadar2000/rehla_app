...
import 'package:welcome_screen/controller/list_cross_game.dart';
import 'package:welcome_screen/main.dart';
import 'package:welcome_screen/routes/path.dart';

class ListCrossGameScreen extends GetView<ListCrossGame> {
  const ListCrossGameScreen({Key? key}) : super(key: key);
                     ...
                     decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                       ...
                       children: [
                         Row(mainAxisAlignment: MainAxisAlignment.end,
                           children: [
                             Text("الاحياء",style: GoogleFonts.readexPro(fontSize: 22,
                         ...
                         Row(mainAxisAlignment: MainAxisAlignment.end,
                           children: [
                             Text("مراحل",style: GoogleFonts.readexPro(fontSize: 16,color: AppColors.white),),
                             SizedBox(width: 5,),
                         ...
                         GestureDetector(
                           onTap: ()  {
                             print("play now");
                             Get.toNamed(AppPath.listCrossGameLevel);
                           },
