                                                    ...
                                                    if (controller
                                                      ...
                                                      return GestureDetector(
                                                        onTap: () {
                                                          controller
                                                              .coursesController
                                                              .profileCourseSelectedIndex = index;
                                                          Get.toNamed(AppPath
                                                              .profileCourse);
                                                        },
                                                        child: Container(
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Text(
                                                                            controller.coursesController.availableCourses[index].teacherName!,
                                                                            style: GoogleFonts.readexPro(
                                                                                fontSize: 20,
                                                                                fontWeight: FontWeight.w500,
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: FadeInImage
                                                                      ...
                                                                      imageErrorBuilder: (BuildContext context,
                                                                        ...
                                                                        return Image.asset(
                                                                            'assets/images/teacher_logo.png'); // Replace with your fallback image
                                                                      },
                                                                    ),
                                                                  ),
                                                                ],
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    children: [
                                                                      Text(
                                                                        "${controller.coursesController.availableCourses[index].countOfCourses}",
                                                                        style: GoogleFonts.readexPro(
                                                                            fontSize:
                                                                                16,
                                                                            color:
