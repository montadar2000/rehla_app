              ...
              child:Column(
                children: [
                  ...
                  Padding(padding: EdgeInsets.symmetric(horizontal: width*0.05),
                    child: Column(
                      children: [
                        Text(language?"Press the button below to download the Exam as PDF":"قم بتحميل اسئلة الاختبار بصيغة PDF بالضغط على الزر ادناه:",style: GoogleFonts.readexPro(
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  language?"Download Exam questions":"تحميل اسئلة الاختبار",
                        ...
                        Text(language?"upload your answer":"رفع الاجابة",style: GoogleFonts.readexPro(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(language?controller.filePath==null?"Choose file":"Cancel":controller.filePath==null?"اختر ملف":"الغاء",style: GoogleFonts.readexPro(fontSize: 16,color:controller.wrongFile?AppColors.appRed: AppColors.appPurpole5),
                                  ),
                                ),
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                    GetBuilder<ExamController>(builder: (controller)=>
                                        Text(language?controller.filePath==null?"no file selected":"File selected success":controller.filePath==null?"لم تقم باختيار ملف بعد":"تم اختيار ملف",style: GoogleFonts.readexPro(fontSize: 16,color:controller.wrongFile?AppColors.appRed:  AppColors.appGrey),
                        ...
                        GetBuilder<ExamController>(builder: (controller)=>Row(mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            Flexible(
                              child: Text(language?"upload file, the size should not exceeded 10MB with type PDF, DOC, or DOCX":'أرفق ملف. يجب ألا يتجاوز حجم ملف مستنداتك 10 ميغا بايت الصيغ المسموحة : PDF, DOC, DOCX',style: GoogleFonts.readexPro(fontSize: 12,color:controller.wrongFile?AppColors.appRed:  AppColors.appGrey),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            Flexible(
                              child: Text(language?"if you faced any issue please connect with teacher ":'في حال مواجهتك لأي مشكلة يرجى التواصل مع مشرف المادة',style: GoogleFonts.readexPro(fontSize: 13,color: AppColors.appGrey),
                                textDirection: TextDirection.rtl,textAlign: TextAlign.start,),
                            ),
                            SizedBox(width: 10,),
                            Stack(
